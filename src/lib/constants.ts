...
import FlinxCategory from '@/components/icons/flinx-category'

export const pricingCards = [
    {
      title: 'Starter',
      description: 'Perfect for trying out flinx',
      price: 'Free',
      duration: '',
    ...
    },
    {
      ...
      priceId: 'price_1Ow2P6SGLx8hcFlVMWARN8Hp',
    },
    {
      title: 'Basic',
      ...
      priceId: 'price_1Ow2P6SGLx8hcFlVs1SAJx3F',
    },
  ]
  ...
  {title:'Priority Support', id:'prod_Plb8MHgIpJAtqT'}
  ]
