...
const PipelineTicket = ({ setAllTickets, ticket, subaccountId, allTickets, index }: Props) => {
    ...
    return (
        <Draggable draggableId={ticket.id.toString()}
            index={index}
        >
            {(provided, snapshot) => {
                ...
                >
                    <AlertDialog>
                        <DropdownMenu>
                            <Card className='my-4 dark:bg-sky-900  bg-white shadow-none transition-all'>
                                ...
                                <CardFooter className='m-0 p-2 border-t-[1px] border-muted-foreground/20 items-center justify-between'>
