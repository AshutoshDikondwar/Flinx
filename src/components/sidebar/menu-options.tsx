                            ...
                            {<Command className='rounded-lg'>
                                        ...
                                        <CommandItem className='!bg-transparent my-2 text-primary border-[1px] border-border rounded-md hover:!bg-muted cursor-pointer transition-all'>
                                            {defaultOpen ? <Link href={`/agency/${user?.Agency?.id}`} className='flex gap-4 w-full h-full'>
                                                <div className='relative w-16'>
                                                    <Image src={user?.Agency?.agencyLogo} alt='agencyLogo' fill className='rounded-md object-contain' />
                                                </div>
                                                <div className='flec flex-col flex-1'>{user?.Agency?.name} <span className='text-muted-foreground'>{user?.Agency?.address}</span></div>
                                ...
                                {(user?.role === 'AGENCY_OWNER' || user?.role === 'AGENCY_ADMIN') && (
                                    <SheetClose >
                                        ...
                                        <Button className='w-full flex gap-2' onClick={() => setOpen(<CustomModal title='Create A Subaccount' subheading='You can switch between your agency account and the subaccount from the sidebar'>
